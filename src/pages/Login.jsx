...
const Login = () => {
  ...
  return (
    <div className='h-[98vh] flex items-center justify-center'>
      ...
      <button className='bg-yellow-400 text-xl font-semibold text-black px-3 py-2 rounded' onClick={submit}>Login</button>
      <Link to="/signup" className='text-gray-600 hover:text-yellow-400'>Not having an account? SignUp first</Link>
      </div>
      </div>
    </div>
  )
