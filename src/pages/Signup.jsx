...
const Signup = () => {
  ...
  return (
    <div className='h-[98vh] flex items-center justify-center'>
      ...
      <input type="email" placeholder='email' className='bg-gray-700 px-3 py-2 my-3 w-full rounded'name='email' required value={Data.email} onChange={change}/>
      ...
      <button className='bg-yellow-400 text-xl font-semibold text-black px-3 py-2 rounded' onClick={submit}>SignUp</button>
